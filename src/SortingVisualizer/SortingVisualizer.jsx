...
const SortingVisualizer = () => {
	const [length, setLength] = useState(100) // in the future I will have a slider to modify the number of elements in the ui
	const [values, setValues] = useState(() =>
		generateRandomArray(5, 500, length)
	)
	const [colors, setColors] = useState(() => Array(length).fill(COLORS.aqua))
	const [delay, setDelay] = useState(2)

  useEffect(() => {
    setValues(generateRandomArray(5, 500, length))
